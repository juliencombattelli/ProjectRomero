...
public class DeviceScanActivity extends AppCompatActivity {
    ...
    public void AddDevice(final BluetoothDevice btDevice) {
        ...
        TableRow tRow = new TableRow(DeviceScanActivity.this);
        LinearLayout lView = new LinearLayout(DeviceScanActivity.this);
        lView.setOrientation(LinearLayout.VERTICAL);

        TextView Text = new TextView(DeviceScanActivity.this);
        Text.setTextColor(Color.BLACK);
        Text.setTypeface(null, Typeface.BOLD);
        Text.setText(deviceName);

        TextView Text2 = new TextView(DeviceScanActivity.this);
        Text2.setTextColor(Color.BLACK);
        Text2.setText(deviceAddress);

        final Button button = new Button(DeviceScanActivity.this);
        button.setId(i);
        i++;
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                final Intent intent = new Intent(DeviceScanActivity.this, RemoteActivity.class);
                intent.putExtra(RemoteActivity.EXTRAS_DEVICE_ADDRESS, deviceAddress);
                startActivity(intent);
            }
        });
